...
macx {QMAKE_POST_LINK += install_name_tool -change "libZFUIWidget.1.dylib" "@rpath/libZFUIWidget.dylib" $$system_path($$OUT_PWD/lib$${ZF_PROJ_NAME}.dylib) $$escape_expand(\\n\\t)}
