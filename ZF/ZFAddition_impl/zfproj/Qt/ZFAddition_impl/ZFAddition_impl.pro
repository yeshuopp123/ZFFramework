...
macx {QMAKE_POST_LINK += install_name_tool -change "libZFAddition.1.dylib" "@rpath/libZFAddition.dylib" $$system_path($$OUT_PWD/lib$${ZF_PROJ_NAME}.dylib) $$escape_expand(\\n\\t)}
